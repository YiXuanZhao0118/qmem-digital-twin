...
/**
 * Glan-Laser Prism (IO-5-850-HP, L=7.5mm) — device template (auto-derived from the live `glan_laser_io5_850` asset).
 *
 ...
 */
export const glan_io5_850 = defineDevice({
  id: "glan_io5_850",
  displayName: "Glan-Laser Prism (IO-5-850-HP, L=7.5mm)",
