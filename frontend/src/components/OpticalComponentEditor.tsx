...
// =============================================================================
// Mirror-specific UX: a single intercept_face anchor, picked from the
// 3D mesh; once picked, two big +/??buttons disambiguate which side of
// the face is the reflective coating.
// =============================================================================
...
// =============================================================================
// Lens-specific status panel (mirrors MirrorFaceSection's role ??// inspector-side summary; the actual operation happens in the
// viewport overlay).
// =============================================================================

function LensFaceSection({
  draft,
  hasOutline,
  lensMode,
  updateDraft,
...
// =============================================================================
// Waveplate-specific status panel: pick flat face ??position;
// X/Y/Z buttons set fast-axis direction in body-local frame.
// Per-instance fast-axis ROTATION around the beam stays in the main
// scene panel's WaveplateAdjustControls (kindParams.fastAxisDegBeamLocal).
// =============================================================================

// =============================================================================
// Laser-source-specific status panel: pick the exit face on the laser
// body (sets `out.positionMmBodyLocal` = face centroid + `directionBodyLocal`
// = OUTWARD face normal — light propagates in this direction). Position
// + direction can also be typed numerically.
// =============================================================================

function LaserSourceFaceSection({
  draft,
  hasOutline,
  updateDraft,
}: {
...
// =============================================================================
// Beam-splitter / PBS status panel: shows whether this is a PBS or a
// BS (inferred from instance kindParams.polarizing for now ??Phase 2
// will promote this to Component.properties.beamSplitterType), plus
// the diagonal interface fields.
// =============================================================================

function BeamSplitterFaceSection({
  draft,
