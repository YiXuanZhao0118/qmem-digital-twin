...
class PhysicsElement(Base):
    ...
    # ``kind_params`` carries per-object PHY config: physics overrides plus
    # non-physics data (PPG timingProgramId, ports, anchor bindings). The
    # 0049 intrinsic_params / state_params split columns were never read and
    # were dropped in alembic 0096 (retirement Phase 6).
