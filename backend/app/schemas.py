...
# Known semantic anchor IDs. Asset anchors may also use custom mechanical
# identifiers (for example partition/binding-tree anchors such as
# ``mount_face_front``), so AssetAnchor.id itself is intentionally typed as
# ``str`` below instead of this closed Literal.
KnownAssetAnchorId = Literal[
