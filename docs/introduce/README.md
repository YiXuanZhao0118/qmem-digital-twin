...
- [Surface optics (plan) · ../surface-optics.md](../surface-optics.md) — tracing free-space parts through their real faces (Snell, Fresnel, curved surfaces, birefringent media) instead of one anchor plane; Phase 0 (the `assets_3d.surface_model` column, 0141) and Phase 1 (the standalone engine `backend/app/optical/surfaces/`) landed 2026-09-23 — the tracer calls neither yet
